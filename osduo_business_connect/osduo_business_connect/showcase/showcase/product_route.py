...
from osduo_business_connect.showcase.showcase.public_api import get_public_product
...
def get_context(context):
    ...
    from osduo_business_connect.business.business.business import get_business_by_slug
